...
import { FormField as IFormField, ScaleConfig } from '../../types/form';
...
const FormField: React.FC<FormFieldProps> = ({
  ...
  return (
    <div 
      ref={setNodeRef} 
      style={style} 
      className="group relative p-6 rounded-lg shadow-sm border border-gray-200 hover:border-blue-300 transition-colors mb-4"
    >
      ...
      <div className="bg-white p-4 rounded-lg space-y-4">
        ...
        {field.type === 'scale' && renderScaleConfig()}
