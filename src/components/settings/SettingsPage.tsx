...
import ObservatorySettings from '../observatory/ObservatorySettings';
...
const Settings = () => {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'security' | 'maintenance' | 'updates' | 'backups' | 'registration' | 'observatory' | 'email' | 'meetings'>('general');
